...
const InnerImage = ({ image, containerSize, nodeId }) => {
    ...
    return (React.createElement("div", { ref: wrapperRef, style: { display: "contents", borderRadius: "inherit", pointerEvents: "none" } }, isStaticRendering ? React.createElement("img", { src: source, style: imageStyle }) : null));
};
export function BackgroundImageComponent({ layoutId, ...rest }) {
    if (layoutId) {
        layoutId = layoutId + "-background";
    }
    return (React.createElement(motion.div, { style: wrapperStyle, layoutId: layoutId },
