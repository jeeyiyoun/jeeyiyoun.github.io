 ...
 * TODO: delete this type when all the framer runtime logic is extracted to src/app/runtime
 */
export declare type ErrorDefinition = ComponentDefinition<{}> & {
    error: string;
 ...
 * TODO: delete this type when all the framer runtime logic is extracted to src/app/runtime
 */
export declare type ComponentType = "component" | "master" | "override" | "action" | "hoc" | "screen" | "responsiveScreen";
/**
 * @internal
 * TODO: delete this type when all the framer runtime logic is extracted to src/app/runtime
 */
export declare type PackageIdentifier = string;
/**
 * @internal
 * TODO: delete this type when all the framer runtime logic is extracted to src/app/runtime
 */
 ...
 * @internal
 */
export declare type SandboxReactComponentDefinition<P = any> = ComponentDefinition<P> & {
    class: React.ComponentType<P>;
};
/**
 * @internal
 */
export declare type ReactComponentDefinition = Omit<SandboxReactComponentDefinition, "class">;
/**
 * @internal
 */
export declare type DesignComponentDefinition = ComponentDefinition & {
