...
export const EmulatedScroll = React.forwardRef(function EmulatedScroll(props, forwardedRef) {
    ...
    return (React.createElement(FrameWithMotion, { "data-framer-component-type": "Scroll", background: "none" // need to set here to prevent default background from Frame
        , ...containerProps, ...size, style: {
            ...
            overflow: "hidden",
        }, onScroll: nativeOnScroll, preserve3d: containerProps.preserve3d, ref: containerRef, layoutId: layoutId, shouldMeasureScroll: true, onBeforeLayoutMeasure: measureAndUpdateScrollOffset },
