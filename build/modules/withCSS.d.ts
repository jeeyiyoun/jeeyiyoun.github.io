 ...
 * @public
 */
export declare const withCSS: <T extends object>(Component: React.ComponentType<T>, escapedCSS: string | string[]) => React.ForwardRefExoticComponent<React.PropsWithoutRef<T> & React.RefAttributes<unknown>>;
