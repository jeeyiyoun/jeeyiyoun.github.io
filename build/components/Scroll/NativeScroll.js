...
export const NativeScroll = React.forwardRef(function NativeScroll(props, forwardedRef) {
    ...
    return (React.createElement(FrameWithMotion, { ref: ref, "data-framer-component-type": "NativeScroll", background: "none" // need to set here to prevent default background from Frame
        , ...containerProps, ...size, onScroll: onScroll, layoutId: layoutId, onBeforeLayoutMeasure: updateScrollOffsetHandler, shouldMeasureScroll: true, className: cx(className, `direction-${direction}`, !scrollBarVisible && "scrollbar-hidden") },
